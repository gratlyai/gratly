    ...
    <div className="h-screen w-full overflow-hidden" style={{ backgroundColor: "#f4f2ee" }}>
      ...
      <div className="bg-white border-b border-gray-200 px-6 flex items-center justify-between shadow-sm fixed top-0 left-0 right-0 z-40 h-16">
        ...
        <div className="flex items-center gap-3">
          {/* AI Assistant Button */}
          <Link
            to={`${basePath}/assistant`}
            className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm hover:bg-gray-50 transition-colors"
            title="AI Assistant"
          >
            <svg
              className="h-5 w-5 text-[#cab99a]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
