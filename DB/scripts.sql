...
CREATE INDEX IF NOT EXISTS IDX_STRIPE_SETTLEMENT_TRANSFER_ID
  ON GRATLYDB.STRIPE_SETTLEMENT_TRANSFERS (TRANSFER_ID);

-- Indexes for Stripe event tables
CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYMENT_EMPLOYEE ON GRATLYDB.STRIPE_PAYMENT_EVENTS (EMPLOYEEGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYMENT_RESTAURANT ON GRATLYDB.STRIPE_PAYMENT_EVENTS (RESTAURANTGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYMENT_INTENT ON GRATLYDB.STRIPE_PAYMENT_EVENTS (PAYMENT_INTENT_ID);

CREATE INDEX IF NOT EXISTS IDX_STRIPE_DISPUTE_EMPLOYEE ON GRATLYDB.STRIPE_DISPUTE_EVENTS (EMPLOYEEGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_DISPUTE_RESTAURANT ON GRATLYDB.STRIPE_DISPUTE_EVENTS (RESTAURANTGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_DISPUTE_CHARGE ON GRATLYDB.STRIPE_DISPUTE_EVENTS (CHARGE_ID);

CREATE INDEX IF NOT EXISTS IDX_STRIPE_BALANCE_CREATED ON GRATLYDB.STRIPE_BALANCE_EVENTS (CREATED_AT);

CREATE INDEX IF NOT EXISTS IDX_STRIPE_TRANSFER_EMPLOYEE ON GRATLYDB.STRIPE_TRANSFER_EVENTS (EMPLOYEEGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_TRANSFER_RESTAURANT ON GRATLYDB.STRIPE_TRANSFER_EVENTS (RESTAURANTGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_TRANSFER_ID ON GRATLYDB.STRIPE_TRANSFER_EVENTS (TRANSFER_ID);

CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYOUT_EMPLOYEE ON GRATLYDB.STRIPE_PAYOUT_EVENTS (EMPLOYEEGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYOUT_RESTAURANT ON GRATLYDB.STRIPE_PAYOUT_EVENTS (RESTAURANTGUID);
CREATE INDEX IF NOT EXISTS IDX_STRIPE_PAYOUT_ID ON GRATLYDB.STRIPE_PAYOUT_EVENTS (PAYOUT_ID);
