...
ALTER TABLE GRATLYDB.SRC_ONBOARDING DROP COLUMN STRIPE_ACCOUNT_ID;

ALTER TABLE GRATLYDB.SRC_ONBOARDING ADD COLUMN PAYOUT_THRESHOLD_CENTS INT DEFAULT 5200;
ALTER TABLE GRATLYDB.SRC_ONBOARDING ADD COLUMN TIMEZONE VARCHAR(128);

ALTER TABLE GRATLYDB.PAYOUT_APPROVAL ADD COLUMN APPROVED_AT DATETIME NULL;
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN APPROVED_AT DATETIME NULL;
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN DEBITED_BATCH_ID INT NULL;
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN PAYOUT_ITEM_ID INT NULL;
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN PAID_AT DATETIME NULL;
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN DEBIT_STATUS VARCHAR(32) DEFAULT 'not_debited';
ALTER TABLE GRATLYDB.PAYOUT_FINAL ADD COLUMN PAYOUT_STATUS VARCHAR(32) DEFAULT 'not_paid';
